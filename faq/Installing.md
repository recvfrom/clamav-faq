...
* `ClamAV-0.102.1.exe` - Traditional executable installer that will install ClamAV in the "Program Files" directory.
* `clamav-0.102.1-rc-win-x64-portable.zip` - Portable install package for 64-bit Windows systems.
* `clamav-0.102.1-rc-win-x86-portable.zip` - Portable install package for 32-bit Windows systems.
