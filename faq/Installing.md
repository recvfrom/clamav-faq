...
### Mandriva <a id="mandriva"></a> ###

```
# urpmi clamav clamd
```

### Gentoo <a id="gentoo"></a> ###
...
### FreeBSD, OpenBSD, NetBSD <a id="bsd"></a> ###

Use the ports Luke.

### Solaris <a id="solaris"></a> ###
